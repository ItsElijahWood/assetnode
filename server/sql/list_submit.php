...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    $stmt = mysqli_prepare($connAssets, 
    ...
    mysqli_stmt_bind_param($stmt, "sisssssssdissssss", 
        $_POST['asset_category'], $_POST['asset_id'], $_POST['asset_type'], $_POST['asset_make'], 
        $_POST['serial_number'], $_POST['purchase_date'], $_POST['warranty_expiration'], $_POST['location'], 
        $_POST['assigned_user'], $_POST['cost'], $_POST['depreciation'], $_POST['condition'], 
        $_POST['mac_address'], $_POST['ip_address'], $_POST['ram'], $_POST['storage_capacity'], $_POST['os']);
